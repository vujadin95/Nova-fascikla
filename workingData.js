...
//             <div class="medal-container">
//               <img class="medal-icon" src=${filteredData.img} />
//               <p class="medal-text" style='color: ${filteredData.color}'>A<span class="medal-num-lvl">2</span></p>
//             </div>
...
//             <div class="medal-container">
//               <img class="medal-icon" src=${filteredData.img} />
//               <p class="medal-text" style='color: ${filteredData.color}'>B<span class="medal-num-lvl">1</span></p>
//             </div>
...
//             <div class="medal-container">
//               <img class="medal-icon" src=${filteredData.img} />
//               <p class="medal-text" style='color: ${filteredData.color}'>B<span class="medal-num-lvl">2</span></p>
//             </div>
